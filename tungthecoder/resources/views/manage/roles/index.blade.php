...
@section('content')
  <div class="flex-container">
    <div class="columns m-t-10">
      ...
      <div class="column has-text-centered">
        <a href="{{route('roles.create')}}" class="button is-primary"><i class="fa fa-user-plus m-r-10"></i> Create New Role</a>
      </div>
    </div>
    <hr class="m-t-0">
    ...
    <div class="columns is-multiline">
      @foreach ($roles as $role)
        <div class="column is-mobile is-one-half-tablet is-one-third-desktop is-one-quarter-fullhd">
