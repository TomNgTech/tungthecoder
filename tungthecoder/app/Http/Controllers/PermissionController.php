...
class PermissionController extends Controller
{
      ...
      if ($request->permission_type == 'basic') {
        ...
        if (count($crud) > 0) {
          foreach ($crud as $x) {
            ...
            $description = "Allows an user to " . strtoupper($x) . ' a(n) ' . ucwords($request->resource);
            $permission = new Permission();
    ...
    public function update(Request $request, $id)
    {
      ...
      $permission->description = $request->description;
      $permission->save();
      Session::flash('success', $permission->display_name . ' permission was successfully updated.');
